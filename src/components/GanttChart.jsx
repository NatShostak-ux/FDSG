...
const GanttChart = ({ 
    ...
    const handleProjectMouseEnter = (e, project, areaColor) => {
        if (draggedProject) return; // Non mostrare se sto draggando
        ...
        setTooltipData({
            ...
            color: areaColor,
            // Posiziona il tooltip sopra il centro della pillola
    ...
    return (
        <div className="w-full border border-gray-200 rounded-lg bg-white relative font-sans Outfit">
            ...
            {tooltipData && (
                <div 
                    className="fixed bg-white text-slate-700 text-[11px] px-3 py-2 rounded-lg shadow-xl border border-gray-200 z-[9999] whitespace-normal w-max max-w-[280px] font-normal pointer-events-none animate-fadeInFast"
                    style={{
